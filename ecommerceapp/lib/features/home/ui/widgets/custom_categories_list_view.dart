...
class _CustomCategoriesListViewState extends State<CustomCategoriesListView> {
  int selectedIndex = 0;
 // String catName='electrionic devices';
        ...
        if (state is CategoriesLoadingState) {
          ...
          return SizedBox(
            ...
            child: ListView.builder(
              ...
              //  catName= state.categories[selectedIndex].name!;
                return Padding(
                    ...
                    child: GestureDetector(
                      ...
                      BlocProvider.of<ProductsCubit>(context).fetchProducts(categoryName:state.categories[index].name!.toString() );
